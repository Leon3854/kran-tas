!(function () {
          ...
          void 0 !== i &&
            ...
            (v(t[a]) && v(r[a])
              ? r[a].__swiper__
                ...
                : w(t[a], r[a])
              : !v(t[a]) && v(r[a])
              ? ((t[a] = {}), r[a].__swiper__ ? (t[a] = r[a]) : w(t[a], r[a]))
              : (t[a] = r[a]));
        }
      }
    }
      ...
      for (let i = 0; i < p; i += 1) {
        ...
        if (
          ...
          if ("auto" === a.slidesPerView) {
            ...
            (S = (r - (a.slidesPerView - 1) * y) / a.slidesPerView),
              a.roundLengths && (S = Math.floor(S)),
      ...
      (t.clickedSlide = a),
        t.virtual && t.params.virtual.enabled
          ? (t.clickedIndex = parseInt(
              h(a).attr("data-swiper-slide-index"),
              10
            ))
          : (t.clickedIndex = i),
  ...
  var O = {
    loopCreate: function () {
      ...
      for (let e = 0; e < o.length; e += 1)
        r.append(h(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
      for (let e = l.length - 1; e >= 0; e -= 1)
        r.prepend(h(l[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
    },
    loopFix: function () {
      const e = this;
  ...
  function I(e) {
    ...
    u && c.target && c.target.shadowRoot && m && (p = h(m[0]));
    ...
    if (
      ...
      p.is(n.focusableElements) &&
        ...
        s.activeElement &&
          h(s.activeElement).is(n.focusableElements) &&
          s.activeElement !== p[0] &&
  ...
  function A(e) {
    ...
    if (!s.allowTouchMove)
      return (
        h(d.target).is(i.focusableElements) || (s.allowClick = !1),
        void (
          i.isTouched &&
  ...
  function D(e) {
    ...
    if (c > a.longSwipesMs) {
      ...
      "next" === t.swipeDirection &&
        (w >= a.longSwipesRatio
          ? t.slideTo(a.rewind && t.isEnd ? g : u + b)
          : t.slideTo(u)),
      ...
      (o.target === t.navigation.nextEl || o.target === t.navigation.prevEl)
        ? o.target === t.navigation.nextEl
          ? t.slideTo(u + b)
          : t.slideTo(u)
        : ("next" === t.swipeDirection && t.slideTo(null !== g ? g : u + b),
  ...
  var q = {
    attachEvents: function () {
      ...
      (e.onTouchStart = I.bind(e)),
        ...
        (e.onClick = B.bind(e)),
        i.touch && !H && (t.addEventListener("touchstart", _), (H = !0)),
        V(e, "on");
    },
  ...
  class K {
    constructor(...e) {
      ...
      (a.__swiper__ = !0),
        (a.support = T()),
        (a.device = S({ userAgent: s.userAgent })),
        (a.browser = $()),
        (a.eventsListeners = {}),
    ...
    mount(e) {
      ...
      let r = (() => {
        ...
        return s.children ? s.children(i()) : h(s).children(i());
      })();
  ...
  (Z = void 0),
      ...
      const ne = [
        function (e) {
          ...
          function l(e) {
            ...
            if (
              ...
              return (
                s.slidesGrid !== u && y !== h && s.slides.css(f, `${y}px`),
                s.updateProgress(),
        ...
        function (e) {
          ...
          function p() {
            ...
            if (
              ("fraction" === s.type &&
                (r.find(K(s.currentClass)).text(s.formatFractionCurrent(p + 1)),
                r.find(K(s.totalClass)).text(s.formatFractionTotal(u))),
              "progressbar" === s.type)
            ) {
              let e;
          ...
          function u() {
            ...
            if ("bullets" === e.type) {
              ...
              a.html(r), (t.pagination.bullets = a.find(K(e.bulletClass)));
            }
            "fraction" === e.type &&
              ((r = e.renderFraction
          ...
          function h() {
            ...
            0 !== s.length &&
              ...
              e.clickable &&
                s.on("click", K(e.bulletClass), function (e) {
                  e.preventDefault();
        ...
        function (e) {
          ...
          function E(e) {
            ...
            l.touch
              ? (d[u](a.start, y, c), d[u](a.move, C, c), d[u](a.end, x, p))
              : (d[u](i.start, y, c), n[u](i.move, C, c), n[u](i.end, x, p));
          }
          function T() {
            const { scrollbar: e, $el: s } = t;
            t.params.scrollbar = U(
              t,
            ...
            0 === r.length &&
              ...
              a.draggable && t.params.scrollbar.el && t.scrollbar.el && E("on"),
              i &&
          ...
          s({
            ...
            i("init", () => {
              !1 === t.params.scrollbar.enabled ? $() : (T(), v(), g());
            }),
        ...
        function (e) {
          ...
          function T(e) {
            ...
            if (
              ...
              return;
            let i, r, l, o, c, u, h, g, v, w, b, y, C, x, E, T, S, $;
            t.params.cssMode &&
              ((t.wrapperEl.style.overflow = "hidden"),
          ...
          function k(e) {
            ...
            t.$wrapperEl[e]("gesturestart", a, b, s),
              t.$wrapperEl[e]("gesturechange", a, y, s),
              t.$wrapperEl[e]("gestureend", a, C, s);
          }
          function L() {
            l || ((l = !0), k("on"));
          }
          ...
          function O() {
            ...
            const s = t.support,
              ...
              r = P();
            s.gestures
              ? (t.$wrapperEl.on(t.touchEvents.start, L, a),
                t.$wrapperEl.on(t.touchEvents.end, z, a))
              : "touchstart" === t.touchEvents.start &&
                (t.$wrapperEl.on(t.touchEvents.start, r, b, a),
                t.$wrapperEl.on(t.touchEvents.move, r, y, i),
                t.$wrapperEl.on(t.touchEvents.end, r, C, a),
                t.touchEvents.cancel &&
                  t.$wrapperEl.on(t.touchEvents.cancel, r, C, a)),
              t.$wrapperEl.on(
                t.touchEvents.move,
          ...
          function I() {
            ...
            const { passiveListener: a, activeListenerWithCapture: i } = M(),
              r = P();
            s.gestures
              ? (t.$wrapperEl.off(t.touchEvents.start, L, a),
                t.$wrapperEl.off(t.touchEvents.end, z, a))
              : "touchstart" === t.touchEvents.start &&
                (t.$wrapperEl.off(t.touchEvents.start, r, b, a),
                t.$wrapperEl.off(t.touchEvents.move, r, y, i),
                t.$wrapperEl.off(t.touchEvents.end, r, C, a),
                t.touchEvents.cancel &&
                  t.$wrapperEl.off(t.touchEvents.cancel, r, C, a)),
              t.$wrapperEl.off(
                t.touchEvents.move,
                `.${t.params.zoom.containerClass}`,
                x,
        ...
        function (e) {
          ...
          function m(e) {
            ...
            t.navigation &&
              ...
              t.pagination &&
                a.is(K(t.params.pagination.bulletClass)) &&
                a[0].click();
          }
          function f() {
            return (
            ...
            x = () => {
              ...
              (o = r),
                ...
                g() &&
                  t.pagination.$el.on(
                    "keydown",
                    K(t.params.pagination.bulletClass),
                    m
                  ),
                t.$el.on("focus", y, !0),
        ...
        function (e) {
          ...
          Object.assign(t, {
            ...
            addSlide: J.bind(t),
            removeSlide: ee.bind(t),
            removeAllSlides: te.bind(t),
          });
        },
        function (e) {
          let { swiper: t, extendParams: s, on: a } = e;
          ...
          const i = (e, s, a) => {
            let i = t.isHorizontal()
              ...
              r = t.isHorizontal()
                ? e.find(".swiper-slide-shadow-right")
                : e.find(".swiper-slide-shadow-bottom");
            0 === i.length && (i = re(a, e, t.isHorizontal() ? "left" : "top")),
              0 === r.length &&
                (r = re(a, e, t.isHorizontal() ? "right" : "bottom")),
              ...
              setTranslate: () => {
                ...
                for (let e = 0, t = a.length; e < t; e += 1) {
                  ...
                  if (
                    ...
                    0 === e.length && (e = re(r, t, n ? "left" : "top")),
                      0 === s.length && (s = re(r, t, n ? "right" : "bottom")),
            ...
            setTranslate: () => {
              ...
              for (let s = 0; s < e.length; s += 1) {
                ...
                if ((m && f.shadow) || !m) {
                  ...
                  if (
                    (0 === e.length && f.shadow && (e = re(r, a)), e.length)
                  ) {
    ...
    "object" == typeof exports && "undefined" != typeof module
      ...
      ? define(Q)
      : ((Z =
          "undefined" != typeof globalThis ? globalThis : Z || self).Swiper =
          Q()),
    J.use([
      function ({ swiper: e, extendParams: t, on: s, emit: a }) {
        function i(t) {
        ...
        t({
          ...
          s("click", (t, s) => {
            const { $nextEl: i, $prevEl: r } = e.navigation,
              n = s.target;
            if (e.params.navigation.hideOnClick && !h(n).is(r) && !h(n).is(i)) {
              if (
                e.pagination &&
                e.params.pagination &&
      ...
      function ({ swiper: e, extendParams: t, on: s, emit: a }) {
        ...
        function d() {
          ...
          if (
            ("fraction" === s.type &&
              (d.find(te(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
              d.find(te(s.totalClass)).text(s.formatFractionTotal(p))),
            "progressbar" === s.type)
          ) {
            let t;
        ...
        s("init", () => {
          ...
          s("click", (t, s) => {
            ...
            if (
              ...
              r &&
              r.length > 0 &&
              !h(i).hasClass(e.params.pagination.bulletClass)
            ) {
              if (
                e.navigation &&
      ...
      function ({ swiper: e, extendParams: t, on: s, emit: i }) {
        ...
        function x(t) {
          ...
          l.touch
            ? (d[u](a.start, b, c), d[u](a.move, y, c), d[u](a.end, C, p))
            : (d[u](i.start, b, c), r[u](i.move, y, c), r[u](i.end, C, p));
        }
        function E() {
          ...
          0 === r.length &&
            ...
            a.draggable && e.params.scrollbar.el && e.scrollbar.el && x("on"),
            i &&
        ...
        t({
          ...
          s("init", () => {
            !1 === e.params.scrollbar.enabled ? S() : (E(), g(), f());
          }),
      ...
      function ({ swiper: e, extendParams: t, on: s, emit: i }) {
        ...
        function h() {
          e.params.autoplay.disableOnInteraction ||
            ((e.autoplay.paused = !1), i("autoplayResume"), n());
        }
      ...
      function ({ swiper: e, extendParams: t, on: s }) {
        ...
        function r() {
          ...
          const s = t.clickedIndex,
            a = t.clickedSlide;
          if (a && h(a).hasClass(e.params.thumbs.slideThumbActiveClass)) return;
          if (null == s) return;
          let i;
          if (
            ((i = t.params.loop
        ...
        function l(t) {
          ...
          if (e.realIndex !== s.realIndex || l) {
            ...
            if (s.params.loop) {
              ...
              (i = e.realIndex), (r = i > e.previousIndex ? "next" : "prev");
            l && (i += "next" === r ? n : -1 * n),
              s.visibleSlidesIndexes &&
                s.visibleSlidesIndexes.indexOf(i) < 0 &&
                (s.params.centeredSlides
    ...
    document.addEventListener("DOMContentLoaded", function () {
      var e,
        ...
        a,
        i,
        r = document.querySelector(".navbar__burger"),
        n = document.querySelector(".navbar__list"),
        l = document.querySelector(".call"),
        o = document.querySelector(".block-form-arenda"),
        d = document.querySelector(".cros-btn__btn"),
        c = document.querySelectorAll(".spollers"),
        p =
          (document.querySelector(".rental-auto-crans"),
          document.querySelector(".spoller-text")),
        u = document.querySelector(".list-rental-cars"),
        h = document.querySelector("video"),
        m = document.querySelector(".psevdo-btn"),
        f = document.querySelector(".btn-play");
      r.addEventListener("click", function (e) {
        r.classList.toggle("active"), n.classList.toggle("active");
      }),
        l.addEventListener("click", function (e) {
          e.preventDefault(), o.classList.add("active");
        }),
        d.addEventListener("click", function (e) {
          o.classList.remove("active");
        }),
        c.forEach(function (e) {
          var t = e.querySelector(".head-spoller");
          t.addEventListener("click", function () {
            t.nextElementSibling.classList.toggle("active");
          });
        }),
        (t = u),
        (e = p).addEventListener("click", function (s) {
          s.preventDefault(),
        ...
        (a = f),
        (i = m),
        (s = h).setAttribute("poster", "./images/dist/vidio/poster.png"),
        i.addEventListener("click", function () {
          i.classList.add("btn-click"),
            a.classList.add("btn-click"),
            console.log(i),
            console.log(a),
            s.setAttribute("controls", "controls");
          var e = s.setAttribute("autoplay", "");
      ...
      new J(".header-slider", {
        ...
        new J(".rental-spec-crane", {
          ...
          pagination: {
            el: ".swiper-pagination.rental-pagination-progres",
            type: "progressbar",
            hide: !0,
          },
          effect: "fade",
      ...
      var g = new J(".implemented-perviewimage-slider", {
        spaceBetween: 10,
        slidesPerView: 10,
        freeMode: !0,
        watchSlidesProgress: !0,
      ...
      new J(".implemented-marge-slider", {
        spaceBetween: 10,
        navigation: {
        ...
        new J(".technology-catalog__slider", {
          slidesPerView: 4,
          slidesPerGroup: 4,
          speed: 2500,
          centeredSlides: 0.5,
          ...
          scrollbar: { el: ".swiper-scrollbar", draggable: !0 },
          navigation: {
            nextEl: ".tech-control-button-next",
            prevEl: ".tech-control-button-prev",
          },
          breakpoints: {
            1500: { centeredSlides: 0.4 },
            1400: { centeredSlides: 0.3 },
            1300: { centeredSlides: 0.2 },
            1200: { centeredSlides: 0.1 },
            1100: { slidesPerView: 3 },
            1e3: { slidesPerView: 3 },
            900: { slidesPerView: 3, slidesPerGroup: 3, spaceBetween: 10 },
            800: {
              slidesPerView: 3,
              slidesPerGroup: 3,
              centeredSlides: 0.3,
